...
class Drools1Test {
    ...
    void test1() {
        ...
        KieContainer droolsKnowledge = TestUtils.droolsKnowledge("src/test/drl/droolsTest1_1.drl");
    ...
    void test2() {
        Knowledge knowledge = service.newKnowledge();
        KieContainer droolsKnowledge = TestUtils.droolsKnowledge("src/test/drl/droolsTest1_2.drl");
        // $a.i != $b.i
        Predicate<Object[]> beta = arr -> {
            int a1i = (int) arr[0];
            int b1i = (int) arr[1];
    ...
    void test3() {
        Knowledge knowledge = service.newKnowledge();
        KieContainer droolsKnowledge = TestUtils.droolsKnowledge("src/test/drl/droolsTest1_3.drl");
        // $a.i != $b.i
        Predicate<Object[]> beta = arr -> {
            int a1i = (int) arr[0];
            int b1i = (int) arr[1];

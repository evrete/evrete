let chessGame = (function () {
    ...
    function onMessage(evt) {
        ...
        switch (msg['type']) {
            case 'BOARD':
                let board = msg['board'];
                drawBoard(MAIN_BOARD, board, true);
    ...
    function drawSolution(id, board) {
        ...
        drawBoard(svg, board, false);
    }

    function drawBoard(svg, board, listener) {
        // Clean the board
        $(svg).find('g').remove();
    ...
    function onBoardClick(x, y, cell) {
